...
//  My Doctor Test
//
//  Created by Dmitry Dorodniy on 03.11.2024.
//
...
public struct CustomSegmentedControl<Data, Content> : View where Data: Hashable, Content: View {
    ...
    func cornerRadius(_ cornerRadius: CGFloat) -> CustomSegmentedControl {
        var view = self
    ...
    func borderColor(_ borderColor: Color) -> CustomSegmentedControl {
        var view = self
    ...
    func borderWidth(_ borderWidth: CGFloat) -> CustomSegmentedControl {
        var view = self
